export default function ConceptSelect({ value, onChange }) {
  ...
  return (
    <div className="w-full my-5">
      <label className="mr-10 text-xl font-medium">여행 컨셉</label>
      <select name="concept" value={value} onChange={onChange} className="w-2/3 py-1.5 border border-stone-200 bg-stone-0  text-gray-900">
