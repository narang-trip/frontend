  ...
  return (
    <div className="w-full rounded-lg mb-5">
      <button
        ...
        className="px-3 py-4 mx-3 my-4 border flex align-top rounded-3xl bg-stone-200 border-stone-400"
      >
        <div className="grid grid-cols-2 gap-4">
          <div className="relative overflow-hidden group rounded-3xl col-span-1">
            <img
              ...
              alt="tripThumbnail"
              className="w-full h-[9rem] mb-2 transition-transform duration-300 ease-in-out transform scale-100 rounded-3xl group-hover:scale-125"
            />
            {isHovered && (
